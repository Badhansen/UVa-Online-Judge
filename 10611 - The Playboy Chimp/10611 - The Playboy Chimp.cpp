...
int bin_upper (int ara[], int low, int high, int terget)
{
    int mid;
    while (low<=high){
        mid=(low+high)/2;
...
int bin_lower (int ara[], int low, int high, int terget)
{
    int mid;
    while (low<=high){
        mid=(low+high)/2;
...
int main()
{
    ...
    for (int i=0; i<q; i++){
        ...
        cin >> x;
        int up, lo;
        up=bin_upper(ara, 0, n-1, x);
        lo=bin_lower(ara, 0, n-1, x);
        if (lo<0){
            cout << "X" << " ";
        }
        else {
