...
/*
    In this problem one question may appear that
    what is the value of -n!. if n is even number then
    the value is - infinity otherwise + infinity

    According do the definition of factorial, the negative
    number factorial is not define yet but roman function it
    define that a equation that's proves that the value of -n!
    is - infinity if n is even otherwise + infinity.
    -n!=(-1)^(-n-1)/(-n-1)!.
